import pygame,sys,scripts.gameover,scripts.lvl_main,scripts.vic,mysql.connector
import sqlite3
...
def run():
    ...
    star_image=pygame.transform.scale(pygame.image.load('image/star11.png'),(14,14))
    ...
    while True: # game loop
        ...
        if true_scroll[1]>=Screen_height/9:# bottom end
            game.decrease_lives()
            player_rect = pygame.Rect(rect_left, rect_top, 16, 22)
